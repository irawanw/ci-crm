...
(function($){ 	
	...
	var init = function( tb, options){	
		if (DEBUG) console.log( (DEBUG)?'colResizable.init':'' );
	...
	var destroy = function(t){
		if (DEBUG) console.log( (DEBUG)?'colResizable.destroy':'' );
	...
	var createGrips = function(t){	
		if (DEBUG) console.log( (DEBUG)?'colResizable.createGrips':'' );
	...
	var memento = function(t, th){ 
		if (DEBUG) console.log( (DEBUG)?'colResizable.memento':'' );
	...
	var syncGrips = function (t){	
		if (DEBUG) console.log( (DEBUG)?'colResizable.syncGrips':'' );
	...
	*/
	var syncCols = function(t,i,isOver){
		if (DEBUG) console.log( (DEBUG)?'colResizable.syncCols':'' );
	...
	*/
	var applyBounds = function(t){
		if (DEBUG) console.log( (DEBUG)?'colResizable.applyBounds':'' );
	...
	var onGripDrag = function(e){	
		if (DEBUG) console.log( (DEBUG)?'colResizable.onGripDrag':'' );
	...
	var onGripDragOver = function(e){	
		if (DEBUG) console.log( (DEBUG)?'colResizable.onGripDragOver':'' );
	...
	var onGripMouseDown = function(e){
		if (DEBUG) console.log( (DEBUG)?'colResizable.onGripMouseDown':'' );
	...
	var onResize = function(){
		if (DEBUG) console.log( (DEBUG)?'colResizable.onResize':'' );
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				onGripMouseDown: null			//callback function fired the grip's dragging is about to start
            }			
