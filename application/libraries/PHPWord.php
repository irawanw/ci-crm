...
if(!defined('PHPWORD_BASE_PATH')) {
    define('PHPWORD_BASE_PATH', APPPATH."third_party/");
    require PHPWORD_BASE_PATH.'PHPWord/Autoloader.php';
	require_once PHPWORD_BASE_PATH.'PHPWord/simple_html_dom.php';
	require_once PHPWORD_BASE_PATH.'PHPWord/h2d_htmlconverter.php';
