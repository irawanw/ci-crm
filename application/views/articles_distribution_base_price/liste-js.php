  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            Veuillez confirmer la suppression du Articles distribution base price?
      </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#articles_distribution_base_price_supprimer a").click(function(ev){
            ev.preventDefault();
        ...
        $("#articles_distribution_base_price_supprimer").addClass("action-confirm-danger");
