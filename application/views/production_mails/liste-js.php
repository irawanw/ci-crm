<script>
    $(document).ready(function() {
        ...
        /*$('#datatable tbody').on('click', 'tr', function(e) {
            ...
            $('#btn-remove').prop("href", "<?php echo site_url('production_mails/remove');?>/" + data.production_mails_id);

            $('#production_mails_supprimer').removeClass("disabled");
        });

        $('#production_mails_supprimer').click(function(e) {
            e.preventDefault();
