<script>
    ...
    $(document).ready(function() {
        ...
        $("#template-modal-detail").on("change", "form.modal-form select[name='dvi_client']", function() {
            var contact = $(this).val();
            var form = this.form.id;

            // Update the toolbar button for "nouveau correspondant"
            actionMenuBar.href('#template-modal-detail #modal-correspondants_nouveau', contact);
            ...
            $.ajax({
                ...
                function(data) {
                    var select = $("#" + form).find("select[name='dvi_correspondant']");
