...
function appendDataFormUpdate() {			
	...
	if(response.status) {
		...
		//sous type developpement
		$('#update-soustype-development').val(data.sous_type);

		//sous type ressources humaines
		$('#update-soustype-ressources-humaines').val(data.sous_type);

		//sous type commercial
		$('#update-soustype-commercial').val(data.sous_type);
		...
		$('#update-message').val(data.message_id);
		$('#update-salarie').val(data.salarie);
		$('#update-annee').val(data.annee);
		$('#update-article').val(data.article);
		$('#update-departement').val(data.departement);
		$('#update-recruitment-type').val(data.recruitment_type);
		$('#update-statuts-assemblees-type').val(data.statuts_assemblees_type);
		$('#update-nom-organisme').val(data.nom_organisme);
		$('#update-sous-traitants-type').val(data.sous_traitants_type);
	}
	},"json");			
}
...
function showSubFormUpdateSousTypeAdministratifsDivers(value) {
	...
	$('#update-annee').val("");
	$('#update-societe').val("");
	$('#update-assemblees').val("");
	$('#update-nom-organisme').val("");
	$('#update-statuts-assemblees-type').val("");
	$('#update-sous-traitants-type').val("");
	$('#update-nom-organisme').val("");	
...
function appendFormUpdateSousType(documentType, value) {
	...
	if(documentType == "Infographie") {							
		...
		showSubFormUpdateSousTypePieceComptable(value);
		...
		showSubFormUpdateSousTypeAdministratifsDivers(value);
	} else if(documentType == "Ressources Humaines") {
		showSubFormSousTypeRessourcesHumaines(value);
	}else if(documentType == "Commercial") {
		showSubFormSousTypeCommercial(value);
	}
}
...
$(document).ready(function() {		
	...
	$('#update-soustype-ressources-humaines').change(function(e) {		
		showSubFormSousTypeRessourcesHumaines($(this).val());
	});

	$('#update-soustype-commercial').change(function(e) {		
