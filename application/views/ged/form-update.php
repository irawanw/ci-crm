...
<form class="UpdateMetaData" method="post" action="<?php echo site_url('ged/update');?>">	
	...
	<div class="col-md-3 subform-soustype-commercial subform">
		...
		<select class="form-control" id="update-soustype-commercial" name="soustype-commercial">
			<option>Aucun</option>
	...
	<div class="update-subform-infographie update-subform-documenttype" style="display: none">
		...
		<div class="col-md-3 subform-devis">
	...
	<div class="col-md-3 subform-soustype-development subform">
		<label>Sous-Type</label><br>
		<select class="form-control" id="update-soustype-development" name="soustype-development">
			<option>Aucun</option>
			<option>Texte</option>
	...
	<div class="col-md-3 subform-soustype-ressources-humaines subform">
		<label>Sous-Type</label><br>
		<select class="form-control" id="update-soustype-ressources-humaines" name="soustype-ressources-humaines">
			<option>Aucun</option>
	...
	<div class="col-md-3 subform-format-emailing subform">
		...
		<select class="form-control" id="update-format-emailing" name="format-emailing">
			<option>Aucun</option>
			<option>Text</option>
			<option>Html</option>
		</select>
	...
	<div class="col-md-3 subform-message subform">
		...
		<select class="form-control" id="update-message" name="message">
			<option>Aucun</option>		
	...
	<div class="col-md-3 subform-bass-de-donnee subform">
		...
		<select class="form-control" id="update-bass-de-donnee" name="bass-de-donnee">
			<option></option>
		</select>
	</div>
	<div class="col-md-3 subform-salarie subform">
		<label>Salarie</label><br>
		<input class="form-control" id="update-salarie" name="salarie">
	</div>
	<div class="col-md-3 subform-annee subform">
		<label>Annee</label><br>
		<input class="form-control" id="update-annee" name="annee">
	</div>
	<div class="col-md-3 subform-recruitment-type subform">
		<label>Recruitment Type</label><br>
		<select class="form-control" id="update-recruitment-type" name="recruitment-type">
			<option>Aucun</option>
			<option>CV</option>
			<option>Tests</option>
		</select>
	...
	<div class="col-md-3 subform-article subform">
		...
		<input class="form-control" id="update-article" name="article">
	</div>
	<div class="col-md-3 subform-departement subform">
		<label>Departement</label><br>
		<input class="form-control" id="update-departement" name="departement">
	</div>
	<div class="col-md-3 subform-statuts-assemblees-type subform">
		<label>Statuts assemblees</label><br>
		<select class="form-control" id="update-statuts-assemblees-type" name="statuts-assemblees-type">
			<option>Aucun</option>
	...
	<div class="col-md-3 subform-sous-traitants-type subform">
		...
		<select class="form-control" id="update-sous-traitants-type" name="sous-traitants-type">
			<option>Aucun</option>
	...
	<div class="col-md-3 subform-nom-organisme subform">
		...
		<input class="form-control" id="update-nom-organisme" name="nom-organisme">
	</div>
	<!-- ./SUB FORM GENERAL -->
