...
<head>
    ...
    <title>Reprise des clients</title>
...
<body>
<div class="container">
    <?php echo form_open('reprise3/clients', array('class' => 'form-horizontal'))?>
    <div class="row">
        <div class="col-md-12">
            <h1>Reprise des clients</h1>
            <p><a href="<?php echo site_url('reprise2'); ?>">Reprise des factures</a></p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
