...
<div class="k-header k-grid-toolbar">
        <div class="form-group form-inline text-left">
            <label for="action"> etat </label>
            <select class="form-control input-sm" id="sel_action_all" name="sel_action_all" >
			    <option value="">sélectionner</option>
                <option value="en cours">en cours</option>
                <option value="perdu et supprime">perdu et supprime</option>
                <option value="perdu non supprime">perdu non supprime</option>
            </select>
