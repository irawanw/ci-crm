...
class Migration_Create_table_t_mailchimp_child extends CI_Migration {

	public function up() {
		$sql = <<<'EOT'
CREATE TABLE IF NOT EXISTS `t_mailchimp_child` (
  `mailchimp_child_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`mailchimp_child_id`)
...
EOT;
	...
	public function down() {
		$sql = <<<'EOT'
DROP TABLE IF EXISTS `t_mailchimp_child`;
EOT;
        $this->db->query($sql);
	}
...
/* End of file 20170517214500_create_table_t_mailchimp_child.php */
/* Location: .//tmp/fz3temp-1/20170517214500_create_table_t_mailchimp_child.php */