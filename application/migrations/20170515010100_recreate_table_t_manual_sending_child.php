...
class Migration_Recreate_table_t_manual_sending_child extends CI_Migration {

	
	public function up() {		
        $sql = <<<'EOT'
ALTER TABLE `t_manual_sending_child`
DROP `date_envoi`,
...
/* End of file 20170513010000_recreate_table_t_manual_sending_child.php */
/* Location: .//tmp/fz3temp-1/20170513010000_recreate_table_t_manual_sending_child.php */