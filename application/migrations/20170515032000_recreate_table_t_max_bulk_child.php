...
class Migration_Recreate_table_t_max_bulk_child extends CI_Migration {

	public function up() {   
        $sql = <<<'EOT'
ALTER TABLE `t_max_bulk_child`
DROP `date_envoi`,
...
/* End of file 20170513033000_recreate_table_t_max_bulk_child.php */
/* Location: .//tmp/fz3temp-1/20170513033000_recreate_table_t_max_bulk_child.php */