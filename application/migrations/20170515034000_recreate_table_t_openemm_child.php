...
class Migration_Recreate_table_t_openemm_child extends CI_Migration {

	public function up() {   
        $sql = <<<'EOT'
ALTER TABLE `t_openemm_child`
DROP `date_envoi`,
...
/* End of file 20170513033000_recreate_table_t_openemm_child.php */
/* Location: .//tmp/fz3temp-1/20170513033000_recreate_table_t_openemm_child.php */