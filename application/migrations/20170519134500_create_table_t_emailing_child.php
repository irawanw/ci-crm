...
class Migration_Create_table_t_emailing_child extends CI_Migration {

	public function up() {
		$sql = <<<'EOT'
CREATE TABLE IF NOT EXISTS `t_emailing_child` (
  `emailing_child_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `open_pourcentage` double(9,2) NOT NULL,
...
echo $this->db->query($sql);
	...
	public function down() {
		$sql = <<<'EOT'
DROP TABLE IF EXISTS `t_emailing_child`;
EOT;
echo $this->db->query($sql);
	}
